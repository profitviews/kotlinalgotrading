How to install everything required to run the code in this repo.  Note that if you have **any issues** please join the [ProfitView Discord](https://discord.gg/34Jy8STJRg).
